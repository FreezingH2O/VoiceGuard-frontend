...
const config: Record<Verdict, { label: string; icon: LucideIcon; bg: string; text: string }> = {
  safe: { label: 'Safe', icon: CircleCheck, bg: 'bg-safe-100', text: 'text-safe-500' },
  suspicious: { label: 'Suspicious', icon: TriangleAlert, bg: 'bg-warn-100', text: 'text-warn-500' },
  scam: { label: 'Scam', icon: ShieldAlert, bg: 'bg-danger-100', text: 'text-danger-600' },
}
